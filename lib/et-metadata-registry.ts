...
export const etLayoutMetadata: Record<string, () => Promise<{ metadata?: Metadata }>> = {
  ...
  '/koristusteenus/hoolduskoristus': () => import('@/app/_pages/koristusteenus/hoolduskoristus/layout'),
  ...
  '/puhastusteenused/suurpuhastus': () => import('@/app/_pages/puhastusteenused/suurpuhastus/layout'),
