export const pageMetadata: Record<string, { title: string; description: string }> = {
  ...
  '/koristusteenus/valikoristus/tanavakivide-pesu-ja-hooldus': {
    title: 'Tänavakivide pesu ja hooldus Tallinnas | SPS Grupp',
  ...
  '/puhastusteenused/eskalaatorite-suvapuhastus': {
    title: 'Eskalaatorite süvapuhastus Tallinnas | SPS Grupp',
  ...
  '/remonditeenused-tallinnas/sanitaarremont-ja-umberehitus': {
    title: 'Sanitaarremont ja ümberehitus Tallinnas | SPS Grupp',
    description: 'Sanitaarremont ja vannitoa ümberehitus. Kvaliteetne ja kiire teenus.',
  },
...
export const localizedPageMetadata: Partial<
  Record<'en' | 'ru', Record<string, { title: string; description: string }>>
> = {
  en: {
    '/': {
    ...
    '/koristusteenus/kaubanduspindade-koristus': {
      ...
      description: 'Regular retail space cleaning from €1.20/m² per month for properties from 800 m² in Tallinn and Harjumaa.',
    },
    '/koristusteenus/tootmishoonete-koristus': {
      title: 'Industrial Building Cleaning in Harjumaa | SPS Grupp',
      description: 'Regular industrial cleaning from €1.20/m² per month for production facilities and warehouses from 800 m².',
    },
    '/koolide-koristamine': {
      title: 'School and Kindergarten Cleaning in Tallinn | SPS Grupp',
      description: 'Regular cleaning for schools and kindergartens from €1.20/m² per month. We serve properties from 800 m².',
    },
    '/puhastusteenused': {
    ...
    '/remonditeenused-tallinnas/plaatimistood': {
      ...
      description: 'Professional floor and wall tiling for commercial and residential properties in Tallinn and Harjumaa.',
    },
    '/sps-grupp/arvamused': {
      title: 'Client Reviews and Feedback | SPS Grupp',
      description: 'Read what SPS Grupp clients say about our cleaning, maintenance and renovation services.',
    },
    '/koristusteenus/valikoristus': {
      title: 'Outdoor Cleaning in Tallinn and Harjumaa | SPS Grupp',
      description: 'Outdoor cleaning and grounds maintenance: facade and window washing, graffiti removal, paving care and snow clearing.',
    },
    '/koristusteenus/valikoristus/grafiti-eemaldamine': {
      title: 'Professional Graffiti Removal in Tallinn | SPS Grupp',
      description: 'Fast, surface-safe graffiti removal for commercial buildings and outdoor surfaces in Tallinn and Harjumaa.',
    },
    '/koristusteenus/valikoristus/kojameheteenus': {
      title: 'Janitor Services in Tallinn and Harjumaa | SPS Grupp',
      description: 'Day-to-day outdoor upkeep and property maintenance for commercial properties and housing associations.',
    },
    '/koristusteenus/valikoristus/lehtedekoristamine': {
      title: 'Leaf Removal in Tallinn and Harjumaa | SPS Grupp',
      description: 'Seasonal leaf collection and removal for commercial properties, office parks and housing associations.',
    },
    '/koristusteenus/valikoristus/muruniitmine': {
  ...
  ru: {
    ...
    '/koristusteenus/tootmishoonete-koristus': {
      ...
      description: 'Регулярная уборка производственных помещений и складов от 1,20 €/м² в месяц, начиная с 800 м².',
    },
    '/koolide-koristamine': {
      title: 'Уборка школ и детских садов в Таллинне | SPS Grupp',
    ...
    '/remonditeenused-tallinnas/plaatimistood': {
      ...
      description: 'Профессиональная укладка напольной и настенной плитки в коммерческих и жилых помещениях.',
    },
    '/sps-grupp/arvamused': {
      title: 'Отзывы клиентов | SPS Grupp',
      description: 'Отзывы клиентов SPS Grupp о клининге, обслуживании недвижимости и ремонтных работах.',
    },
    '/koristusteenus/valikoristus': {
      title: 'Уборка территорий в Таллинне и Харьюмаа | SPS Grupp',
      description: 'Уборка и содержание территорий: мойка фасадов и окон, удаление граффити, уход за брусчаткой и уборка снега.',
    },
    '/koristusteenus/valikoristus/grafiti-eemaldamine': {
      title: 'Удаление граффити в Таллинне и Харьюмаа | SPS Grupp',
      description: 'Быстрое и безопасное для поверхности удаление граффити с фасадов и других наружных поверхностей.',
    },
    '/koristusteenus/valikoristus/kojameheteenus': {
      title: 'Услуги дворника в Таллинне и Харьюмаа | SPS Grupp',
      description: 'Ежедневное содержание территории для коммерческих объектов и квартирных товариществ.',
    },
    '/koristusteenus/valikoristus/lehtedekoristamine': {
      title: 'Уборка листьев в Таллинне и Харьюмаа | SPS Grupp',
      description: 'Сезонный сбор и вывоз листьев с территорий коммерческих объектов и квартирных товариществ.',
    },
    '/koristusteenus/valikoristus/muruniitmine': {
