...
const registry: Record<string, PageEntry> = {
  ...
  '/remonditeenused-tallinnas/betoonitood': { load: () => import('@/app/remonditeenused-tallinnas/page').then((m) => m.default) },
  '/remonditeenused-tallinnas/elektritood': { load: () => import('@/app/remonditeenused-tallinnas/elektritood/page').then((m) => m.default) },
  '/remonditeenused-tallinnas/garderoobide-ehitus': { load: () => import('@/app/remonditeenused-tallinnas/page').then((m) => m.default) },
  ...
  '/remonditeenused-tallinnas/torutood-2': { load: () => import('@/app/remonditeenused-tallinnas/torutood/page').then((m) => m.default) },
  ...
  '/valikoristus': { load: () => import('@/app/koristusteenus/valikoristus/page').then((m) => m.default) },
  '/valikoristus/akende-pesu': { load: () => import('@/app/koristusteenus/valikoristus/akende-pesu/page').then((m) => m.default) },
  '/valikoristus/fassaadipesu': { load: () => import('@/app/koristusteenus/valikoristus/fassaadipesu/page').then((m) => m.default) },
  '/valikoristus/grafiti-eemaldamine': { load: () => import('@/app/koristusteenus/valikoristus/grafiti-eemaldamine/page').then((m) => m.default) },
  '/valikoristus/kojameheteenus': { load: () => import('@/app/koristusteenus/valikoristus/kojameheteenus/page').then((m) => m.default) },
  '/valikoristus/lehtedekoristamine': { load: () => import('@/app/koristusteenus/valikoristus/lehtedekoristamine/page').then((m) => m.default) },
  '/valikoristus/lumekoristus': { load: () => import('@/app/koristusteenus/valikoristus/lumekoristus/page').then((m) => m.default) },
  '/valikoristus/muruniitmine': { load: () => import('@/app/koristusteenus/valikoristus/muruniitmine/page').then((m) => m.default) },
  '/valikoristus/tanavakivide-pesu-ja-hooldus': { load: () => import('@/app/koristusteenus/valikoristus/tanavakivide-pesu-ja-hooldus/page').then((m) => m.default) },
