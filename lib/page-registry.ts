...
const registry: Record<string, PageEntry> = {
  ...
  '/koristusteenus/hoolduskoristus': { load: () => import('@/app/_pages/koristusteenus/hoolduskoristus/page').then((m) => m.default) },
  ...
  '/puhastusteenused/suurpuhastus': { load: () => import('@/app/_pages/puhastusteenused/suurpuhastus/page').then((m) => m.default) },
