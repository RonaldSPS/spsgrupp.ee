...
const LEGACY_RU_REDIRECTS: Record<string, string> = {
  // --- RU repair hub children (mis-filed services) ---
  "/ru/услуги-по-ремонту-в-таллинне/бетонные-работы": "/ru/услуги-по-ремонту-в-таллинне/",
  "/ru/услуги-по-ремонту-в-таллинне/строительство-гардеробной": "/ru/услуги-по-ремонту-в-таллинне/",

  // --- RU pre-migration slugs (were in next.config but never matched) ---
  ...
  // --- Older RU site generations found in GSC (2026-09 audit) ---
  "/ru/услуги-по-уборке": "/ru/услуги-по-уборке-в-таллинне/",
  "/ru/услуги-по-уборке/уборка-офисов": "/ru/услуги-по-уборке-в-таллинне/уборка-офисов/",
  "/ru/услуги-по-уборке/уборка-производственных-помещений": "/ru/услуги-по-уборке-в-таллинне/уборка-промышленных-зданий/",
  "/ru/услуги-по-уборке/уборка-торговых-помещений": "/ru/услуги-по-уборке-в-таллинне/уборка-торговых-помещений/",
  "/ru/услуги-по-уборке-в-таллинне/очистка-торговых-площадей-в-харьюмаа": "/ru/услуги-по-уборке-в-таллинне/уборка-торговых-помещений/",
  "/ru/специальные-работы-по-уборке": "/ru/клининговые-услуги-для-бизнеса/",
  "/ru/специальные-работы-по-уборке/утилизация-строительного-мусора": "/ru/вывоз-строительного-мусора/",
  "/ru/специальные-работы-по-уборке/чистка-ковров": "/ru/клининговые-услуги-для-бизнеса/чистка-ковров/",
  "/ru/специальные-работы-по-уборке/очистка-после-коронавирус": "/ru/клининговые-услуги-для-бизнеса/дезинфекция/",
  "/ru/специальные-работы-по-уборке/уборка-и-чистка-после-строительства": "/ru/клининговые-услуги-для-бизнеса/послестроительная-уборка/",
  "/ru/специальные-работы-по-уборке/очистка-диванов-и-другой-мягкой-мебел": "/ru/клининговые-услуги-для-бизнеса/",
  "/ru/специальные-работы-по-уборке/глубокая-очистка-эскалаторов-делает": "/ru/клининговые-услуги-для-бизнеса/глубокая-чистка-эскалаторов/",
  "/ru/специальные-работы-по-уборке/уход-за-полами": "/ru/клининговые-услуги-для-бизнеса/уход-за-полами/",
  "/ru/специальные-работы-по-уборке/очистка-от-следов-пожара-и-дыма": "/ru/клининговые-услуги-для-бизнеса/уборка-после-пожара/",
  "/ru/уборка-территорий-делает-каждую-комп": "/ru/уборка-и-обслуживание-территорий/",
  "/ru/уборка-территорий-делает-каждую-комп/мойка-фасадов": "/ru/уборка-и-обслуживание-территорий/мойка-фасадов/",
  "/ru/уборка-территорий-делает-каждую-комп/уборка-снега": "/ru/уборка-и-обслуживание-территорий/уборка-снега/",
  "/ru/уборка-территорий-делает-каждую-комп/кошение-газона": "/ru/уборка-и-обслуживание-территорий/стрижка-газонов/",
  "/ru/уборка-территорий-делает-каждую-комп/мойка-окон": "/ru/уборка-и-обслуживание-территорий/мойка-окон/",
  "/ru/уборка-территорий-делает-каждую-комп/удаление-граффити": "/ru/уборка-и-обслуживание-территорий/удаление-граффити/",
  "/ru/уборка-территорий-делает-каждую-комп/мойка-и-уход-за-мощеничными-камнями-на": "/ru/уборка-и-обслуживание-территорий/мойка-тротуарной-плитки/",
  "/ru/запросите-предложение": "/ru/свяжитесь-с-sps-group/",
  "/ru/приходите-к-нам-на-работу": "/ru/приходите-работать-к-нам/",
  "/ru/sps-grupp-услуги-по-уборке-и-поддерживанию": "/ru/группа-sps/",
  "/ru/офис": "/ru/услуги-по-уборке-в-таллинне/уборка-офисов/",
  // Old RU blog/news artifacts (blog exists only in ET)
...
export async function proxy(request: NextRequest) {
  ...
  const legacyRuDestination =
    LEGACY_RU_REDIRECTS[decodedPathname] ??
    LEGACY_RU_PREFIX_REDIRECTS.find(([prefix]) => decodedPathname.startsWith(prefix))?.[1]
  if (legacyRuDestination) {
    return NextResponse.redirect(new URL(legacyRuDestination, request.url), 308)
  }
