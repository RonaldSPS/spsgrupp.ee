...
export default function EskalaatoriteSuvapuhastus() {
  return (
    <>
      <SeoJsonLd
        etPath="/puhastusteenused/eskalaatorite-suvapuhastus"
        locale="et"
        ...
        breadcrumbs={[{ name: "Avaleht", etPath: "/" }, { name: "Puhastusteenused", etPath: "/puhastusteenused" }, { name: "Eskalaatorite süvapuhastus", etPath: "/puhastusteenused/eskalaatorite-suvapuhastus" }]}
      ...
      <main id="main-content" tabIndex={-1}>
        ...
        >
          <HeroBackgroundImage src="/eskalaatorite-suvapuhastus-1.jpg" preload alt="" />
          {/* Floating chips */}
