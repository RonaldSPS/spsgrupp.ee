          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-[30px] md:gap-[60px] items-start max-w-[1280px] mx-auto w-full relative z-10">
            ...
            >
              ...
              <div className="text-white/70 text-[15px] font-light mb-3">
                Kõik vaibatüübid <span className="text-white/40 mx-2">|</span> Allergiavabad meetodid <span className="text-white/40 mx-2">|</span> Kiire kuivamine <span className="text-white/40 mx-2">|</span> ISO 14001
              </div>
