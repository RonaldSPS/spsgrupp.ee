...
const customFAQ = [
  ...
  },
  {
    ...
    a: "Tavaliselt kasutame aurupuhastust. See eemaldab sügava mustuse ja bakterid. Kõrge liiklusega kohtadele ja eriti määrdunud vaipadele soovitame keemilist süvapuhastust. Vaibatüüp määrab meetodi.",
  },
  {
    q: "Kui kaua võtab aega vaibapuhastus ja kuivamine?",
  ...
  },
  {
    ...
    a: "Esmalt hindame ning anname ausa vastuse, mida on võimalik teha.",
  },
];
...
export default function VaipadePuhastus() {
  return (
    <>
      <SeoJsonLd
        etPath="/puhastusteenused/vaipade-puhastus"
        locale="et"
        ...
        breadcrumbs={[
          ...
          { name: "Vaipade puhastus", etPath: "/puhastusteenused/vaipade-puhastus" },
        ]}
      ...
      <main id="main-content" tabIndex={-1}>
        ...
        >
          <HeroBackgroundImage src="/vaipade-puhastus-1.webp" preload alt="" />
          {/* Floating chips */}
          ...
          <section className="py-[100px] bg-white">
            <div className="max-w-[1280px] mx-auto px-[5%]">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-[40px] text-[16px] text-[#2f353f] leading-[1.8] font-light">
                <div>
                  <p><strong>Pealtnäha puhas vaip võib varjata tolmulestasid, sadu tuhandeid baktereid, hallitusseente eoseid, õietolmu ja inimestelt pärinevaid osakesi.</strong></p>
