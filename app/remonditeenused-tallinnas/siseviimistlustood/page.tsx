          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-[30px] md:gap-[60px] items-start max-w-[1280px] mx-auto w-full relative z-10">
            ...
            >
              ...
              <div className="text-white/70 text-[15px] font-light mb-3">
                Kogenud meeskond <span className="text-white/40 mx-2">|</span> Kiire töö <span className="text-white/40 mx-2">|</span> Puhas töökoht <span className="text-white/40 mx-2">|</span> Garantii <span className="text-white/40 mx-2">|</span> Kindlustatud tööd
              </div>
