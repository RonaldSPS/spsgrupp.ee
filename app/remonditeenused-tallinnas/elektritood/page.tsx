...
export default function ElektritoodLeht() {
  ...
  return (
    <>
      <SeoJsonLd
        etPath="/remonditeenused-tallinnas/elektritood"
        locale="et"
        ...
        breadcrumbs={[{ name: "Avaleht", etPath: "/" }, { name: "Remonditeenused Tallinnas", etPath: "/remonditeenused-tallinnas" }, { name: "Elektritööd", etPath: "/remonditeenused-tallinnas/elektritood" }]}
      ...
      <main id="main-content" tabIndex={-1}>
        ...
        >
          <HeroBackgroundImage src={heroPilt} preload alt="" />
          {/* Floating chips */}
