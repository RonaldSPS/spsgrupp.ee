...
export default function TorutoodLeht() {
  ...
  return (
    <>
      <SeoJsonLd
        etPath="/remonditeenused-tallinnas/torutood"
        locale="et"
        ...
        breadcrumbs={[{ name: "Avaleht", etPath: "/" }, { name: "Remonditeenused Tallinnas", etPath: "/remonditeenused-tallinnas" }, { name: "Torutööd", etPath: "/remonditeenused-tallinnas/torutood" }]}
      ...
      <main id="main-content" tabIndex={-1}>
        <section
          ...
          aria-label="Torutööd"
        >
          <HeroBackgroundImage src="/torutood-1.jpg" preload alt="" />
