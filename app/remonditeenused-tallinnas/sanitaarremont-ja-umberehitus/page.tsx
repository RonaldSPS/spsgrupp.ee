  ...
  return (
    <>
      <SeoJsonLd
        ...
        serviceUrl="https://spsgrupp.ee/remonditeenused-tallinnas/sanitaarremont-ja-umberehitus"
        breadcrumbs={[{ position: 1, name: "Avaleht", item: "https://spsgrupp.ee" }, { position: 2, name: "Remonditeenused Tallinnas", item: "https://spsgrupp.ee/remonditeenused-tallinnas" }, { position: 3, name: "Sanitaarremont ja ümberehitus", item: "https://spsgrupp.ee/remonditeenused-tallinnas/sanitaarremont-ja-umberehitus" }]}
      ...
      <main>
        <section
          ...
          style={{ background: "url('/sanitaarremont-1.jpg') center/cover no-repeat" }}
        >
