...
export default function KojameheteenusLeht() {
  return (
    <>
      <SeoJsonLd
        etPath="/remonditeenused-tallinnas/kojameheteenus"
        locale="et"
        ...
        breadcrumbs={[{ name: "Avaleht", etPath: "/" }, { name: "Remonditeenused Tallinnas", etPath: "/remonditeenused-tallinnas" }, { name: "Kojamehe teenus", etPath: "/remonditeenused-tallinnas/kojameheteenus" }]}
      ...
      <main id="main-content" tabIndex={-1}>
        ...
        >
          <HeroBackgroundImage src="/kojameheteenus-1.jpg" preload alt="" />
