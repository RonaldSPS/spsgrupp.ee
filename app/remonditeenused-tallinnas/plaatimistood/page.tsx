...
export default function PlaatimistoodLeht() {
  return (
    <>
      <SeoJsonLd
        etPath="/remonditeenused-tallinnas/plaatimistood"
        locale="et"
        ...
        breadcrumbs={[{ name: "Avaleht", etPath: "/" }, { name: "Remonditeenused Tallinnas", etPath: "/remonditeenused-tallinnas" }, { name: "Plaatimistööd", etPath: "/remonditeenused-tallinnas/plaatimistood" }]}
      ...
      <main id="main-content" tabIndex={-1}>
        ...
        >
          <HeroBackgroundImage src="/plaatimistood-1.jpg" preload alt="" />
