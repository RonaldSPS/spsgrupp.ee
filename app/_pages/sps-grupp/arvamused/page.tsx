...
const textByLocale: Record<Locale, ReviewsPageText> = {
  et: {
    ...
    videoDescription: "Vaata, kuidas aitasime ligi 2800 õppijaga kõrgkoolil luua tervislikuma õpikeskkonna.",
  ...
  en: {
    ...
    videoDescription: "See how we helped a university of applied sciences with nearly 2,800 students create a healthier learning environment.",
  ...
  ru: {
    ...
    videoDescription: "Посмотрите, как мы помогли техническому колледжу с почти 2800 студентами создать более здоровую учебную среду.",
