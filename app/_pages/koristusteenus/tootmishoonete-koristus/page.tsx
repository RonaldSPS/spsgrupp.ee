...
interface IndustrialCleaningText {
  serviceName: string;
...
const etText: IndustrialCleaningText = {
  ...
  ariaLabel: "Tootmishoonete koristus",
  heroChips: [
    { value: "Alates 2006", label: "tööstuskogemust" },
    { value: "ISO 14001", label: "sertifitseeritud" },
    { value: "Kindlustatud", label: "teenus" },
  ],
  h1Line1: "Tootmishoonete ja",
  h1Line2: "tööstuspindade koristus",
  heroDescription: "Ohutu ja põhjalik tootmispindade hooldus. Õli, rasva ja tolmuga toime tulev meeskond. Töötame ka öösel ja nädalavahetustel, et mitte segada tootmist.",
  ctaButton: "Küsi tootmishoone koristuspakkumist",
  breadcrumbHome: "Avaleht",
  breadcrumbService: "Koristusteenus",
  breadcrumbCurrent: "Tootmishoonete koristus",
  problemHeading: "Tootmishoone koristus ei ole tavaline koristus",
  problemP1Strong: "Tootmiskeskkonnas on puhtus tootlikkuse alus.",
  problemP1Text: "Õliplekkideta põrandad, puhtad masinate ümbrused ja korrastatud tasapinnad loovad keskkonna, kus töö käib sujuvalt ja ohutult. SPS Grupp on spetsialiseerunud just sellistele nõudlikele töökeskkondadele.",
  problemP2Strong1: "Meie meeskond tunneb tööstuslikke puhastusprotsesse läbi ja lõhki.",
  problemP2Text1: "Kasutame õigeid vahendeid, arvestame tootmisrütmiga ja hoiame ohutust prioriteedina.",
  problemP2Strong2: "20 aasta jooksul oleme töötanud tootmishoonetes üle kogu Harjumaa.",
  problemP2Text2: "See kogemus tähendab, et tuleme toime raskesti eemaldatavate tööstuslike jääkide, õli, rasva ja metalliosakestega ning teeme seda viisil, mis hoiab teie tootmise käimas.",
  servicesTag: "Teenuse sisu",
  servicesHeading: "Mida sisaldab tootmishoonete koristusteenus?",
  services: [
  ...
  whyUsTag: "Miks meie",
  whyUsHeading: "Miks tööstusettevõtted usaldavad SPS Grupi?",
  whyUsImage: "/Tootmishoonete-koristus-2.webp",
  whyUsImageAlt: "Tootmishoone koristus SPS Grupp",
  whyUs: [
    { title: "Tööstuskogemus ja vastav väljaõpe", desc: "Meie meeskond on läbinud tööohutuskoolituse ja teab, kuidas liikuda tootmiskeskkonnas. Me ei sega tootmist." },
    { title: "Töötame siis, kui tootmine seisab", desc: "Öine, varahommikune või nädalavahetuse töö. Kohandame graafiku teie tootmisrütmiga." },
    { title: "Spetsialiseeritud vahendid", desc: "Kasutame õlieemaldusaineid, rasvaeemaldusaineid ja professionaalseid survepesuseadmeid. Meil on ISO 14001 keskkonnasertifikaat." },
    { title: "Dokumentatsioon ja ohutusnormid", desc: "Järgime kõiki tööohutuse nõudeid, peame logisid ja esitame regulaarseid raporteid." },
  ],
  pricingTag: "Hind",
  pricingHeading: "Kuidas kujuneb tootmishoone koristuse hind?",
  pricingDescription: "Tootmishoone koristuse hind sõltub pindalast, mustuse iseloomust, koristuse sagedusest ja töögraafikust.",
  pricingNote: "Tootmishooned nõuavad läbimõeldud lähenemist koristusele. Koristusfirma SPS Grupp pakub terviklikku plaani, mis lähtub just tootmise spetsiifilistest tingimustest.",
  testimonialsTag: "Klientide tagasiside",
  testimonialsHeading: "Mida ütlevad meie tootmis- ja laokliendid",
  testimonials: [
    { quote: "Täname tehtud töö ja panustatud pingutuse eest. Lao ja tootmiskoristuse tööd said korrektselt tehtud, koostöö sujus hästi ning jäime lõpptulemusega rahule.", shortQuote: "Lao ja tootmiskoristuse tööd said korrektselt tehtud, koostöö sujus hästi ning jäime lõpptulemusega rahule." },
    { quote: "Soovin avaldada tunnustust väga hea koristusteenuse eest. Nii ladu kui ka kontoriruumid on puhtad, korras ja hästi hooldatud. Tehtud töö kvaliteet on olnud järjepidevalt kõrgel tasemel.", shortQuote: "Nii ladu kui ka kontoriruumid on puhtad, korras ja hästi hooldatud. Tehtud töö kvaliteet on olnud järjepidevalt kõrgel tasemel." },
    { quote: "SPS Grupp on olnud meie jaoks usaldusväärne koostööpartner. Nii tootmis-, lao- kui ka kontoriruumide korrashoid on olnud järjepidevalt kõrgel tasemel.", shortQuote: "Nii tootmis-, lao- kui ka kontoriruumide korrashoid on olnud järjepidevalt kõrgel tasemel." },
  ],
  processTitle: "Kuidas SPS tööstushoone koristuse käivitab?",
  processIntro: "Tootmispinna puhul algab teenus riskide ja töövoo mõistmisest. Alles siis saab valida inimesed, seadmed ja graafiku.",
  processSteps: [
  ...
  footerTitle: "Küsige tootmishoone koristuse pakkumist",
  ...
  faq: [
    { q: "Kui sageli peaks tootmishoonet koristama?", a: "Sõltub tootmise intensiivsusest. Tavaliselt vähemalt kord nädalas, tolmurohketes või õlirohketes tingimustes tihedamini, sageli igapäevaselt. Sanitaarruumid ja puhkeruumid vajavad igapäevast hooldust." },
    { q: "Kas koristus saab toimuda väljaspool tootmisaega?", a: "Jah. Enamus meie tootmishoonete koristustöid toimub öösiti, nädalavahetustel või tootmispausides. Me ei sega teie tootmisprotsessi." },
    { q: "Kas kasutate keskkonnasõbralikke vahendeid?", a: "Eelistame väiksema keskkonnamõjuga puhastusvahendeid kõikjal, kus pinnad ja ohutusnõuded seda võimaldavad. Õlieemalduseks kasutame spetsiaalseid biolagunevaid aineid. Järgime ISO 14001 standardit." },
    { q: "Kas SPS Grupp koristab ka õli- või suitsukahjustusi?", a: "Jah, meil on kogemus suitsu-, vee- ja õlikahjustuste puhastamisel tööstuskeskkonnas. Pakume ka hädaolukorra reageerimist." },
    { q: "Kas teil on tööohutuskoolitused?", a: "Jah, kõik meie tootmishoonete koristajad läbivad tööohutuskoolituse, kasutavad isikukaitsevahendeid ja järgivad kliendi kehtestatud ohutusreegleid." },
  ],
};
...
function localizedText(locale: Exclude<Locale, "et">): IndustrialCleaningText {
  const content = asRecord(getLocalizedContent(locale, "tootmishooneteKoristus")) ?? {};
  ...
  return {
    ...
    heroChips: [
      ...
      { value: str(hero.chip2Badge) || "ISO 14001", label: str(hero.chip2Label) || etText.heroChips[1].label },
...
function getText(locale: Locale): IndustrialCleaningText {
...
export default function TootmishooneteKoristus() {
  return <TootmishooneteKoristusPageView locale="et" />;
}

export function TootmishooneteKoristusPageView({ locale }: { locale: Locale }) {
