...
const copy = {
  et: {
    ...
    facts: [
      ...
      { value: "300+", text: "Ettevõttes töötab üle 300 inimese — koristajad, hooldustöölised, elektrid ja torumehed." },
      { value: "200+", text: "Meid usaldab enam kui 200 äriklienti: büroohooned, kauplused, tootmishooned ja korteriühistud." },
      { value: "1M+ m²", text: "Igapäevaselt on meie hoolduses üle 1 000 000 ruutmeetri äripindu Tallinnas ja Harjumaal." },
  ...
  en: {
    ...
    facts: [
      ...
      { value: "1M+ m²", text: "Every day we maintain over 1,000,000 square metres of commercial space in Tallinn and Harju County." },
  ...
  ru: {
    ...
    facts: [
      ...
      { value: "1M+ m²", text: "Ежедневно мы обслуживаем более 1 000 000 квадратных метров коммерческих площадей в Таллинне и Харьюмаа." },
