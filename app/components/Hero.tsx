...
const FloatingChip = ({
  ...
  <div
    className="floating-chip animate-float hover:shadow-lg transition-shadow duration-200 cursor-default"
...
export default function Hero() {
  ...
  return (
    ...
    >
      <Image src="/FrontHeroCar.jpg" alt="" fill preload fetchPriority="high" sizes="100vw" className="object-cover z-0" />
