  ...
  columns: [
    {
      ...
      subSections: [
        ...
        },
        {
          ...
          items: [
            { label: "Muru niitmine", href: "/koristusteenus/valikoristus/muruniitmine-seo-naidis" },
            { label: "Lehtede koristamine", href: "/koristusteenus/valikoristus/lehtedekoristamine-seo-naidis" },
            { label: "Kojamehe teenus", href: "/koristusteenus/valikoristus/kojameheteenus-seo-naidis" },
            { label: "Lumekoristus", href: "/koristusteenus/valikoristus/lumekoristus-seo-naidis" },
          ],
        },
      ],
    },
